...
class SubstitutionModel {
    ...
    letterToNumberActive: ko.Observable<string>
    rotate13Active: ko.Observable<string>
    rotateValue: ko.Observable<string>
    aciiActive: ko.Observable<string>
    morseActive: ko.Observable<string>

    delimiter: ko.Observable<string>

    morseDot: ko.Observable<string>
    morseDash: ko.Observable<string>
...
class WordSearchModel {
    ...
    searchType: ko.Observable<boolean>

    output: ko.Observable<string>
    resultCount: ko.Observable<string>
    dbStatus: ko.Observable<string>

    outputProcessor: ko.Computed<string>
...
class CrosswordSearchModel {
    ...
    clueOutput: ko.Observable<string>
    answerOutput: ko.Observable<string>
    resultCount: ko.Observable<string>
    dbStatus: ko.Observable<string>
